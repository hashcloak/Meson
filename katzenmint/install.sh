...
parse_args() {
  #BINDIR is ~/opt/meson unless set be ENV
  # over-ridden by flag below

  BINDIR=${BINDIR:-~/opt/meson}
...
# if [ "$OS" = "windows" ]; then
#   echo "Meson didn't support windows for now."
# fi
